...
function Experience() {
    ...
    const AddNewExperience = () => {
        ...
        const experiencData = {
            ...
            state: data?.experience[0]?.state,
            startDate: data?.experience[0]?.startDate,
            endDate: data?.experience[0]?.endDate,
            workSummery: data?.experience[0]?.workSummery,
            resumeId: params?.resumeId
        }


        data.experience.length && GlobalApi.updateResumeExperience(params?.resumeId, experiencData).then(res => {
            if (res) {
    ...
    const onSave = () => {
        ...
        GlobalApi.updateResumeExperience(params?.resumeId, experiencData).then(res => {
            if (res) {
                setLoading(false);
                toast('Details updated !')
            }
